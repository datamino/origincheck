...
export class EnhancedGatewayMonitor {
  ...
  async startDashboard() {
    try {
      ...
      server.listen(this.config.dashboard.port, this.config.dashboard.host, () => {
        console.log(`🖥️ Dashboard started: http://${this.config.dashboard.host}:${this.config.dashboard.port}`);
      });
